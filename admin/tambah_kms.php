...
$title = "Tambah Data KMS || Posyandu Melati";
...
// Ambil data ID Balita untuk dropdown
try {
    $stmt_balita = $koneksi->prepare("SELECT id_balita, nama_balita, jenis_kelamin, nama_ibu, p_persalinan FROM tb_balita");
    $stmt_balita->execute();
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Tambah Data KMS</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                        <li class="breadcrumb-item active">Tambah Data KMS</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Form Tambah Data KMS</h3>
                        </div>
                        <form method="POST" action="proses_admin/p_tambah_kms.php">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="id_balita">Balita</label>
                                    <select name="id_balita" class="form-control" id="id_balita" required>
                                        <option value="">-- Pilih Nama Balita --</option>
                                        <?php while ($row_balita = $result_balita->fetch_assoc()): ?>
                                            <option value="<?php echo $row_balita['id_balita']; ?>"
                                                data-jenis_kelamin="<?php echo htmlspecialchars($row_balita['jenis_kelamin']); ?>"
                                                data-nama_ibu="<?php echo htmlspecialchars($row_balita['nama_ibu']); ?>"
                                                data-p_persalinan="<?php echo htmlspecialchars($row_balita['p_persalinan']); ?>">
                                                <?php echo htmlspecialchars($row_balita['nama_balita']); ?>
                                            </option>
                                        <?php endwhile; ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input type="number" name="tinggi_badan" class="form-control" id="tinggi_badan" placeholder="Masukkan Tinggi Badan" step="0.01" required>
                                    </div>
                                    <div class="form-group col-sm-4">
                                        <label for="berat_badan">Berat Badan (kg)</label>
                                        <input type="number" name="berat_badan" class="form-control" id="berat_badan" placeholder="Masukkan Berat Badan" step="0.01" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="form-group col-sm-6">
                                        <label for="status_gizi_bb_umur">Status Gizi Berat Badan menurut Umur</label>
                                        <input type="text" name="status_gizi_bb_umur" class="form-control" id="status_gizi_bb_umur" required readonly>
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label for="status_gizi_bb_tinggi">Status Gizi Berat Badan menurut Tinggi</label>
                                        <input type="text" name="status_gizi_bb_tinggi" class="form-control" id="status_gizi_bb_tinggi" required readonly>
                                    </div>
                                </div>
...
<script>
    document.getElementById('id_balita').addEventListener('change', function() {
        ...
        document.getElementById('nama_ibu').value = selectedOption.getAttribute('data-nama_ibu');
        document.getElementById('p_persalinan').value = selectedOption.getAttribute('data-p_persalinan');
    });
    var table_umur = {
        'Laki-laki': {
